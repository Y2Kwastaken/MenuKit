...
public interface MenuSlot {
    ...
    class Builder {
         ...
         *
         * @param index the index, must be within the bounds of the provided {@link #inventory(PagedInventory)}
         * @return this builder
         * @since 1.0.0-SNAPSHOT
         */
         ...
         *
         * @param page the page, must be within the page count of the provided {@link #inventory(PagedInventory)}
         * @return this builder
         * @since 1.0.0-SNAPSHOT
         */
        ...
        /**
         * Sets both the {@link #click(MenuEventCallback)} and {@link #drag(MenuEventCallback)} properties of this
         * builder to just cancel the provided event.
         *
        ...
        /**
         * Builds this menu slot as specified with previous fields.
         *
         * @return the newly created MenuSlot
         * @since 1.0.0-SNAPSHOT
         */
